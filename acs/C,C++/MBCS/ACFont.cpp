...
// Desc : »ý¼ºÀÚ
//==================================================================================================
GCFont::GCFont(LPDIRECT3DDEVICE9 D3DDevice)
{
...
bool GCFont::InitFont(char* font, int Width, int Height)
{
	HRESULT hr;
...
void GCFont::ShowText(char *str, int x, int y, D3DCOLOR color)
{
	RECT rect;
	rect.left	= x;
	rect.right	= 640;
...
void GCFont::ShowFPS(int x, int y, D3DCOLOR color)
{
